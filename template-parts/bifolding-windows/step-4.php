            ...
            <div class="option-group">
                <div class="colour-options-grid">
                    ...
                    <div class="colour-option-card" data-option="anthracite_grey">
                        <input type="radio" name="window_colour" id="colour_anthracite" value="anthracite_grey" class="price-option" data-price="0" checked>
                    ...
                    <div class="colour-option-card" data-option="black">
                        <input type="radio" name="window_colour" id="colour_black" value="black" class="price-option" data-price="0">
                    ...
                    <div class="colour-option-card" data-option="white">
                        <input type="radio" name="window_colour" id="colour_white" value="white" class="price-option" data-price="0">
                    ...
                    <div class="colour-option-card custom-colour-card" data-option="custom_ral">
                        <input type="radio" name="window_colour" id="colour_custom" value="custom_ral" class="price-option" data-price="195">
