<?php
/**
 * Window Builder - Step 11: Installation Type Selection
 *
 * @package Astra Child
 */
...
<div class="wizard-step" data-step="11" id="installation-step">
    <div class="step-container">
        ...
        <div class="installation-options-container">
            <div class="installation-options-grid">
                ...
                <div class="installation-option-card">
                    <input type="radio" name="window_installation_type" id="install_collection" value="collection" class="installation-price-option" data-price="0" checked>
                ...
                <div class="installation-option-card">
                    <input type="radio" name="window_installation_type" id="install_delivery" value="delivery" class="installation-price-option" data-price="delivery_calculated">
                ...
                <div class="installation-option-card">
                    <input type="radio" name="window_installation_type" id="install_prepared" value="prepared_opening" class="installation-price-option" data-price="per_panel" data-base-price="200">
                ...
                <!-- Remove Existing Windows & Install -->
                <div class="installation-option-card">
                    <input type="radio" name="window_installation_type" id="install_remove" value="remove_existing" class="installation-price-option" data-price="removal" data-base-price="200" data-removal-fee="550">
                    <label for="install_remove">
                        <div class="installation-radio-visual"></div>
                        <div class="installation-image-container">
                            <img src="<?php echo esc_url($images_dir . 'remove-existing-install.png'); ?>" alt="Remove Existing Windows & Install" loading="lazy">
                        </div>
                        <div class="installation-label-content">
                            <span class="installation-option-title">Remove Existing Windows & Install</span>
                            <div class="installation-price-wrapper">
        ...
        <!-- Photo Upload Section (visible only for Remove Existing) -->
        <div class="installation-photo-upload" id="photo-upload-section" style="display: none;">
            <div class="upload-header">
                <h3>Upload photo of your existing window</h3>
            ...
            <div class="upload-single">
                <div class="upload-box single">
                    ...
                    <h4>Window Photo</h4>
                    <p class="upload-help">Upload a clear photo of your existing window</p>
...
jQuery(document).ready(function($) {
    ...
    // Use window builder's pane count function
    ...
    $('input[name="window_installation_type"]').on('change', function() {
        ...
        $(document).trigger('installationTypeChanged', [val]);
    });
    ...
    window.validateInstallationStep = function() {
        ...
        if (selectedType === 'remove_existing') {
            var photoFile = $('#window_photo').val();
            if (!photoFile) {
                alert('Please upload a photo of your existing window');
                return false;
            }
        }
        return true;
