<?php
/**
 * Window Builder - Step 12: Access Issues
 *
 * @package Astra Child
 */
...
<div class="wizard-step" data-step="12">
    <div class="step-container access-container">
        <div class="step-title access-title">
            ...
            <p class="access-description">e.g. will the windows fit through your property to get to the opening?</p>
        </div>
...
jQuery(document).ready(function($) {
    ...
    function showTextarea() {
        ...
        setTimeout(function(){ $('#access_description').focus(); },300);
    }
    ...
    $('.access-card').on('click',function(e){
        if($(e.target).is('textarea') || $(e.target).hasClass('access-tick-image') || $(e.target).hasClass('access-cross-image')) return;
        const radio = $(this).find('input[type="radio"]');
        if(radio.attr('id') === 'access_yes') showTextarea();
        else hideTextarea();
    });
    ...
    $('.access-textarea').on('click',function(e){ e.stopPropagation(); });
